...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        <ol class="breadcrumb breadcrumb-transparent mb-0">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('admin.ticket.proses') }}">Ticket Proses</a>
            </li>
        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-end mb-2">
                    ...
                    <a href="#" class="btn btn-danger btn-sm" id="btn-close-ticket"><i
                            class="fa fa-power-off mr-1"></i><span
                            class="font-weight-bold">Tutup Tiket</span></a>
                    <form method="post" action="{{ route('admin.ticket.proses.close', ['id' => $data->id]) }}" id="form-close-ticket">
                        @csrf
                    </form>
                </div>
                <hr>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#btn-close-ticket').on('click', function (e) {
                e.preventDefault();
                Swal.fire({
                    title: "Konfirmasi!",
                    text: "Apakah anda yakin ingin menutup ticket?",
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
